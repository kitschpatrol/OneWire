...
//
// The OneWire library's "search" method will return all devices on a bus, but not
// necessaruly in the order they're actually attached. The DS28EA00 Theremometer implements 
...
// with the same signatures and usage as the search function, but which return devices in order.
